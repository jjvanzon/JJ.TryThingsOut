...
namespace MonoCross.Utilities.BarcodeScanning
{
    ...
    public enum Symbology
    {
        ...
        UPCA,               // target, redlaser?, linea-pro, koamtec 300i
        UPCE,               // target, redlaser, linea-pro, koamtec 300i
        EAN8,               // target, redlaser, linea-pro, koamtec 300i
        EAN13,              // target, redlaser, linea-pro, koamtec 300i
        Code11,             // koamtec 300i
        Code32,             // koamtec 300i
        Code39,             // target, redlaser, linea-pro, koamtec 300i
        Code93,             // redlaser (android only)
        Code128,            // target, redlaser, linea-pro, koamtec 300i
