...
namespace MonoCross.Utilities.BarcodeScanning
{
    ...
    {
        /// <summary>
        /// Initialize the barcode scanner returned, may or may not do anything depending on the scanner
        /// </summary>
        /// <returns></returns>
        bool Initialize();
        ...
        /// </summary>
        event EventHandler BarcodeScannerReady;
        ...
        /// <summary>
        /// returns true if a manual start is required to initiate a scan 
        /// </summary>
        bool NeedsStartToScan {get;}
